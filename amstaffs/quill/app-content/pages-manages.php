            ...
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb"> 
                                ...
                                <li class="breadcrumb-item"><a href="#" class="text-dark">Manage</a>
                                </li>
                                <li class="breadcrumb-item active"><a href="#" class="text-dark">Pages</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        ...
                        <a class="btn btn-dark text-white" data-toggle="modal" data-target="#defaultNew"><i class="feather icon-plus"></i> New Page</a> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <div class="btn-group float-md-center" role="group" aria-label="Button group with nested dropdown"> 
                                                            ...
                                                            <!-- // BLOCK / UNBLOCK -->
                                                            <a class="btn btn-dark text-white" data-toggle="modal" data-target="#defaultBlock<?php echo $row['id']; ?>">
