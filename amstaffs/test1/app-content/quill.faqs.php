                        ...
                        <form action="quill-photos" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control border-dark" style="color: black;" name="faq_question" required="" placeholder="e.g., How do I reset my password?">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control border-dark" style="color: black;" name="faq_answer" required="" placeholder="Provide the detailed answer here." rows="5"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control border-dark" style="color: black;" name="faq_order" value="0" min="0" placeholder="0">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="quill-faqs-actions.php" method="POST">
                            ...
                            <label>FAQ Question:</label>
                            <div class="form-group">
                                <input type="text" class="form-control border-dark" style="color: black;" name="faq_question" required="" placeholder="e.g., How do I reset my password?" value="<?php echo $question; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control border-dark" style="color: black;" name="faq_answer" required="" placeholder="Provide the detailed answer here." rows="5"><?php echo htmlspecialchars($item['faq_answer']); ?></textarea>
                            </div>

                            <!-- Display Order -->
                            <label>Display Order (Optional):</label>
                            <div class="form-group">
                                <input type="number" class="form-control border-dark" style="color: black;" name="faq_order" min="0" value="<?php echo htmlspecialchars($item['faq_order']); ?>">
                            </div>
