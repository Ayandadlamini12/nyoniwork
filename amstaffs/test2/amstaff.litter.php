    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Litter Info</h4>
...
<p class="mb-4">
    Our next Litter is expected to arrive middle March 2025, bred from Champion Hector and kennel matriarch Skye.
</p>
 
                        </div>
                        <div class="d-flex ms-2 mb-5">
                            <a class="btn btn-dark py-2 px-3 px-sm-4 me-2" href="puppies"> <span>View Gallery - Puppies</span> <i class="fas fa-chevron-circle-right"></i></a>
                            <a class="btn btn-dark py-2 px-3 px-sm-4 mx-2" href="contact-us"> <span>Enquire Here</span> <i class="fas fa-chevron-circle-right"></i></a> 
                        </div>
