                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form action="quill-photos" method="POST">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" class="form-control border-dark" style="color: black;" id="followHeader" name="follow_header" placeholder="e.g., Follow Our Journey" maxlength="255" value="<?php echo safe_output($data['follow_header']); ?>">
                                                                                        </div>
                                                                    
                                                                                        <div class="row">
                                                                                            <div class="col-md-4 form-group">
                                                                                                <label for="locationHeader">Location Header:</label>
                                                                                                <input type="text" class="form-control border-dark" style="color: black;" id="locationHeader" name="location_header" placeholder="e.g., Find Us" maxlength="255" value="<?php echo safe_output($data['location_header']); ?>">
                                                                                            </div>
                                                                                            <div class="col-md-4 form-group">
                                                                                                <label for="mailHeader">Mail Header:</label>
                                                                                                <input type="text" class="form-control border-dark" style="color: black;" id="mailHeader" name="mail_header" placeholder="e.g., Email Us" maxlength="255" value="<?php echo safe_output($data['mail_header']); ?>">
                                                                                            </div>
                                                                                            <div class="col-md-4 form-group">
                                                                                                <label for="callHeader">Call Header:</label>
                                                                                                <input type="text" class="form-control border-dark" style="color: black;" id="callHeader" name="call_header" placeholder="e.g., Give Us A Call" maxlength="255" value="<?php echo safe_output($data['call_header']); ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <textarea class="form-control border-dark" style="color: black;" id="locationText" name="location" placeholder="Enter full physical address" rows="3"><?php echo safe_output($data['location']); ?></textarea>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4 form-group">
                                                                                                ...
                                                                                                <input type="email" class="form-control border-dark" style="color: black;" id="mailAddress" name="mail" placeholder="e.g., support@example.com" maxlength="255" value="<?php echo safe_output($data['mail']); ?>">
                                                                                            </div>
                                                                                            <!-- PHONE NUMBER -->
                                                                                            <div class="col-md-4 form-group">
                                                                                                <label for="callNumber">Phone Number:</label>
                                                                                                <input type="text" class="form-control border-dark" style="color: black;" id="callNumber" name="call" placeholder="e.g., +1 (555) 123-4567" maxlength="255" value="<?php echo safe_output($data['call']); ?>">
                                                                                            </div>

                                                                                            <!-- PHONE NUMBER -->
                                                                                            <div class="col-md-4 form-group">
                                                                                                <label for="callNumber">Follow @:</label>
                                                                                                <input type="text" class="form-control border-dark" style="color: black;" id="callNumber" name="follow" placeholder="@HellentorAmstaff" maxlength="255" value="<?php echo safe_output($data['follow']); ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <textarea class="form-control border-dark" style="color: black;" id="gpsMapUrl" name="gps_map_url" placeholder="Paste the embed or direct URL for the map location" rows="4"><?php echo safe_output($data['gps_map_url']); ?></textarea>
                                                                                        ...
                                                                                        <div class="row mb-3">
                                                                                            <div class="col-md-4 form-group mb-0">
                                                                                                ...
                                                                                                <input type="text" class="form-control border-dark" style="color: black;" id="smName<?php echo $i; ?>" name="sm_<?php echo $i; ?>" placeholder="Icon Name (e.g., twitter)" maxlength="255" value="<?php echo safe_output($data["sm_{$i}"]); ?>">
                                                                                            </div>
                                                                                            <div class="col-md-8 form-group mb-0">
                                                                                                <label for="smLink<?php echo $i; ?>">SM <?php echo $i; ?> Link (URL):</label>
                                                                                                <input type="text" class="form-control border-dark" style="color: black;" id="smLink<?php echo $i; ?>" name="sm_link<?php echo $i; ?>" placeholder="Full URL (e.g., https://...)" value="<?php echo safe_output($data["sm_link{$i}"]); ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                        <?php endfor; ?>
