                                                ...
                                                <form action="general-info" enctype="multipart/form-data" method="POST">
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="text" class="form-control border-primary square" placeholder="Enter Full Name" value="<?php echo $row['har_fullname'];?>" required name="har_fullname">
                                                                </div>
                                                            </div>
                                                        </div> 
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="email" class="form-control border-primary square" placeholder="Enter Email Address" value="<?php echo $row['har_email'];?>" name="har_email" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="text" class="form-control border-primary square" placeholder="Enter Contact No." value="<?php echo $row['har_phone'];?>" required name="har_phone">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="date" class="form-control border-primary square" placeholder="Enter Date of Birth" value="<?php echo $row['har_date_of_birth'];?>" required name="har_date_of_birth">
                                                                </div>
                                                            </div>
                                                        </div> 
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <textarea class="form-control border-primary square" rows="5" name="har_address" required><?php echo $row['har_address'];?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                            <button type="submit" name="upload" class="btn btn-primary btn-block square">Update Information</button> 
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="hidden" name="id" value="<?php echo $getUserId; ?>">
                                                                    <input type="password" class="form-control square" id="account-old-password" required placeholder="Old Password" name="opassword">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="password" name="password" id="account-new-password" class="form-control square" placeholder="New Password" required minlength="8">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label for="account-retype-new-password">Retype New
                                                                        Password</label>
                                                                    <input type="password" name="rpassword" class="form-control square" required id="account-retype-new-password" data-validation-match-match="password" placeholder="Retype New Password" minlength="8">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                            <button type="submit" class="btn btn-primary btn-block square">Change Password</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>    
