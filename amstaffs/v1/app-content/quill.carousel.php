                                                                        ...
                                                                        <div class="modal-body"> 
                                                                            <form action="quill-photos" enctype="multipart/form-data" method="POST">
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <label>Carousel Title:</label>
                                                                                        <div class="form-group"> 
                                                                                            <input type="text" class="form-control" name="carousel_title" required="" placeholder="Enter Title">
                                                                                            <input type="hidden" name="addNewCarousel" value="1">
                                                                                        </div>
 
                                                                                        <label>Carousel Sub-Title:</label>
                                                                                        <div class="form-group"> 
                                                                                            <input type="text" class="form-control" name="carousel_subtitle" required="" placeholder="Enter Subtitle">
                                                                                            <input type="hidden" name="addNewCarousel" value="1">
                                                                                        </div>  
                                                                                        ...
                                                                                        <label>Carosel Description:</label>
                                                                                        <div class="form-group">
                                                                                            <textarea class="form-control" name="carousel_description" placeholder="Enter Description"></textarea> 
                                                                                        </div>
                                                                                        ...
                                                                                        <?php 
                                                                                            ...
                                                                                            <label>Carousel Position:</label>
                                                                                            <div class="form-group">
                                                                                                <select class="form-control" name="carousel_position" required <?php echo $has_available_position ? '' : 'disabled'; ?>>
