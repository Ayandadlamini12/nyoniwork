    ...
    <div class="card shadow-lg border-0 h-100 rounded-lg">
        <div class="card-content">
            ...
            <div class="card-body"> 
                ...
                <a href="#" data-toggle="modal" data-target="#viewDocModal<?php echo $document_id; ?>" class="btn btn-outline-info rounded-pill">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close Viewer</button>
            </div>
        </div>
    </div>
</div>
...
<div class="row mb-4"> 
    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
        ...
        <a data-toggle="modal" data-target="#NewDocument" class="btn btn-outline-primary">
                        ...
                        <form action="quill-photos" enctype="multipart/form-data" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group"> 
                                    <input type="text" class="form-control" name="document_title" required="" placeholder="e.g., Q3 Puppy Care">
                                </div> 
                                
                                <!-- Document Description -->
                                <label>Description (Optional):</label>
                                <div class="form-group">
                                    <textarea class="form-control" name="document_description" placeholder="A brief description of the document content." rows="3"></textarea> 
                                </div>
