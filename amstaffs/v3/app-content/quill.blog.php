                        ...
                        <div class="modal-body"> 
                            ...
                            <form id="blogPostForm1" action="quill-photos" enctype="multipart/form-data" method="POST">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group"> 
                                        <input type="text" class="form-control border-dark" name="blog_title" required="" value="<?php echo $b_title; ?>" placeholder="Enter the main title"style="color: black;">
                                    </div> 

                                    <!-- Blog Slug -->
                                    <label>URL Slug:</label>
                                    <div class="form-group"> 
                                        <input type="text" class="form-control border-dark" name="blog_slug" value="<?php echo $b_slug; ?>" placeholder="e.g., my-first-post-2024"style="color: black;">
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label>Author:</label>
                                            <div class="form-group"> 
                                                <input type="text" class="form-control border-dark" name="blog_author" required="" value="<?php echo $b_author; ?>" placeholder="Your Name or Username"style="color: black;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group"> 
                                                <input type="text" class="form-control border-dark" name="blog_category" value="<?php echo htmlspecialchars($row['blog_category']); ?>" placeholder="e.g., News, Tips, Updates"style="color: black;">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group"> 
                                                <input type="number" class="form-control border-dark" name="blog_reading_time" min="1" value="<?php echo $b_reading_time; ?>" placeholder="e.g., 5" style="color: black;">
                                            </div>
                                        </div>
                    ...
                    <div class="modal-body"> 
                        ...
                        <form id="blogPostForm" action="quill-photos" enctype="multipart/form-data" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group"> 
                                    <input type="text" class="form-control border-dark" name="blog_title" required="" placeholder="Enter the main title of the post">
                                ...
                                <div class="form-group"> 
                                    <input type="text" class="form-control border-dark" name="blog_slug" placeholder="e.g., my-first-post-2024">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group"> 
                                            <input type="text" class="form-control border-dark" name="blog_author" required="" placeholder="Your Name or Username">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label>Category (Optional):</label>
                                        <div class="form-group"> 
                                            <input type="text" class="form-control border-dark" name="blog_category" placeholder="e.g., News, Tips, Updates">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label>Reading Time (Minutes):</label>
                                        <div class="form-group"> 
                                            <input type="number" class="form-control border-dark" name="blog_reading_time" min="1" placeholder="e.g., 5">
                                        </div>
                                    </div>
