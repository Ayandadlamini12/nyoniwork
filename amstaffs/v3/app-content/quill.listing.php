<div role="tabpanel" class="tab-pane" id="account-vertical-listing" aria-labelledby="account-pill-listing" aria-expanded="false">

                                                <!-- GALLERY IMAGES -->
 
                                                 
                                                    <h4 class="form-section"><i class="fa fa-media"></i> ITEM LISTING</h4> 
                                                            ...
                                                            <div class="row match-height">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4 class="modal-title" id="myModalLabelNewList<?php echo $image_id; ?>">Listing Management</h4>
                                                                                ...
                                                                                <form action="quill-photos" enctype="multipart/form-data" method="POST">
                                                                                   <div class="modal-body">
                                                                                       ...
                                                                                       <div class="form-group"> 
                                                                                        ...
                                                                                        <div class="form-group"> 
                                                                                            <input type="text" class="form-control" name="content_title" required="" value="<?php echo $image_title0; ?>" placeholder="Enter Image Title">
                                                                                        </div> 

                                                                                        <!-- Email Address -->
                                                                                        <label>Image Description:</label>
                                                                                        <div class="form-group">
                                                                                            <textarea class="form-control" name="content_description" placeholder="Enter Image Description"><?php echo $image_title1; ?></textarea> 
                                                                                        </div>  
                                                                ...
                                                                <div class="modal fade text-left" id="deleteNewListing<?php echo $image_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabelNewListing<?php echo $image_id; ?>" aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4 class="modal-title" id="myModalLabelNewListing<?php echo $image_id; ?>">Listing Management</h4>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                            <a data-toggle="modal" data-target="#addNewListing" class="btn btn-outline-danger">New Listing</a>
                                                            ...
                                                            <div class="modal fade text-left" id="addNewListing" tabindex="-1" role="dialog" aria-labelledby="myModalLabelAddNewListing" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title" id="myModalLabelAddNewListing">Listing Management</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
