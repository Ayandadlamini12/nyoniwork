                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2 mb-md-0">
                            <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link d-flex text-dark" id="account-pill-gallery" data-toggle="pill" href="#account-vertical-gallery" aria-expanded="false">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link d-flex text-dark" id="account-pill-listing" data-toggle="pill" href="#account-vertical-listing" aria-expanded="false">
