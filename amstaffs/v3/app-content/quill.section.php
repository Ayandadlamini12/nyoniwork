                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                    ...
                                                                                                    <form action="quill-photos" method="POST">
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            <input type="text" class="form-control" name="section_key_display" readonly value="<?php echo htmlspecialchars($item['section']); ?>">
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            <input type="text" class="form-control" id="sectionTitle" name="section_title" placeholder="Enter Main Title" value="<?php echo htmlspecialchars($item['title']); ?>">
                                                                                                        </div>
                                                                                    
                                                                                                        <!-- 2. Subtitle Input (Corresponds to 'subtitle' column) -->
                                                                                                        <label for="sectionSubtitle">Subtitle:</label>
                                                                                                        <div class="form-group">
                                                                                                            <input type="text" class="form-control" id="sectionSubtitle" name="section_subtitle" placeholder="Enter Subtitle" value="<?php echo htmlspecialchars($item['subtitle']); ?>">
                                                                                                        </div>
                                                                                    
                                                                                                        <!-- 3. Description Textarea (Corresponds to 'description' column) -->
                                                                                                        <label for="sectionDescription">Description:</label>
                                                                                                        <div class="form-group">
                                                                                                            <textarea class="form-control" id="sectionDescription" name="section_description" placeholder="Enter Main Description" rows="6"><?php echo htmlspecialchars($item['description']); ?></textarea>
                                                                                                        </div>
