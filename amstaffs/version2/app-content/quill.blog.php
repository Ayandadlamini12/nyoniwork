            ...
            <div class="col-xl-6 col-md-6 col-sm-12">
                <div class="card shadow-lg rounded-xl mb-4">
                    <div class="card-content">
                        ...
                        <img class="card-img-top img-fluid" src="../assets/uploads/blogs/<?php echo $b_image_path; ?>" alt="<?php echo $b_title; ?> Featured Image" style="height: 200px; object-fit: cover;">
                        <?php else: ?>
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title text-primary font-weight-bold mb-2"><?php echo $b_title; ?></h4>
                            ...
                            <!-- Reading Time & Status -->
                            <div class="d-flex justify-content-between align-items-center mb-3 pt-1 border-top mt-2">
                            ...
                            <!-- Display a content snippet -->
                            <p class="card-text text-gray-700 mb-4"><?php echo substr($b_content, 0, 150) . (strlen($b_content) > 150 ? '...' : ''); ?></p>
                            
                            <a data-toggle="modal" data-target="#manageBlog<?php echo $blog_id; ?>" class="btn btn-outline-secondary mr-2">Manage</a>
                            <a data-toggle="modal" data-target="#deleteBlog<?php echo $blog_id; ?>" class="btn btn-outline-danger">Delete</a>
                        </div>
                    </div>
                </div>
            </div> 
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabelManageBlog<?php echo $blog_id; ?>">Manage Blog Post: <?php echo $b_title; ?></h4>
                        ...
                        <div class="modal-body"> 
                            ...
                            <form action="quill-blog-actions.php" enctype="multipart/form-data" method="POST">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mb-4"> 
                                        ...
                                        <center>
                                            <img class="card-img-top img-fluid w-75 rounded-lg" src="<?php echo $display_image_path; ?>" alt="<?php echo $b_title; ?> Image" style="max-height: 250px; object-fit: cover;">
                                        </center>
                                    </div>
                                    ...
                                    <div class="form-group"> 
                                        <input type="text" class="form-control" name="blog_title" required="" value="<?php echo $b_title; ?>" placeholder="Enter the main title">
                                    </div> 

                                    <!-- Blog Slug -->
                                    <label>URL Slug:</label>
                                    <div class="form-group"> 
                                        <input type="text" class="form-control" name="blog_slug" value="<?php echo $b_slug; ?>" placeholder="e.g., my-first-post-2024">
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label>Author:</label>
                                            <div class="form-group"> 
                                                <input type="text" class="form-control" name="blog_author" required="" value="<?php echo $b_author; ?>" placeholder="Your Name or Username">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group"> 
                                                <input type="text" class="form-control" name="blog_category" value="<?php echo htmlspecialchars($row['blog_category']); ?>" placeholder="e.g., News, Tips, Updates">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group"> 
                                                <input type="number" class="form-control" name="blog_reading_time" min="1" value="<?php echo $b_reading_time; ?>" placeholder="e.g., 5">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="blog_content" rows="10" required><?php echo $b_content; ?></textarea> 
                                    </div>  
                                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body"> 
                            ...
                            <form action="quill-blog-actions.php" method="POST">
                               <div class="modal-body">
                    ...
                    <div class="modal-body"> 
                        ...
                        <form action="quill-photos" enctype="multipart/form-data" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group"> 
                                    <input type="text" class="form-control" name="blog_title" required="" placeholder="Enter the main title of the post">
                                </div> 
                                
                                <!-- Blog Slug (Optional, for manual override) -->
                                <label>URL Slug (Optional):</label>
                                <div class="form-group"> 
                                    <input type="text" class="form-control" name="blog_slug" placeholder="e.g., my-first-post-2024">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group"> 
                                            <input type="text" class="form-control" name="blog_author" required="" placeholder="Your Name or Username">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label>Category (Optional):</label>
                                        <div class="form-group"> 
                                            <input type="text" class="form-control" name="blog_category" placeholder="e.g., News, Tips, Updates">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label>Reading Time (Minutes):</label>
                                        <div class="form-group"> 
                                            <input type="number" class="form-control" name="blog_reading_time" min="1" placeholder="e.g., 5">
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div id="full-wrapper">
                                                        <div id="full-container">
                                                            <div class="editor">
                                                                <h1 class="ql-align-center">Blog Text Here</h1>
