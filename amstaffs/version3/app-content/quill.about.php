                                                                            ...
                                                                            <div class="modal-body"> 
                                                                                ...
                                                                                <form action="quill-photos" enctype="multipart/form-data" method="POST">
                                                                                    ...
                                                                                    <div class="form-group"> 
                                                                                        <input type="text" class="form-control" id="aboutTitle" name="about_title" required placeholder="Enter Main Title" value="<?php echo htmlspecialchars($about_data['about_title'] ?? ''); ?>">
                                                                                    </div>
                                                                                    
                                                                                    <label for="aboutSubtitle">Subtitle:</label>
                                                                                    <div class="form-group"> 
                                                                                        <input type="text" class="form-control" id="aboutSubtitle" name="about_subtitle" placeholder="Enter Subtitle" value="<?php echo htmlspecialchars($about_data['about_subtitle'] ?? ''); ?>"> 
                                                                                    </div>
                                                                
                                                                                    <label for="aboutDescription">Description:</label>
                                                                                    <div class="form-group">
                                                                                        <textarea class="form-control" id="aboutDescription" name="about_description" placeholder="Enter Main Description" rows="6"><?php echo htmlspecialchars($about_data['about_description'] ?? ''); ?></textarea> 
                                                                                    </div>
                                                                                    ...
                                                                                    ?>
                                                                                        ...
                                                                                        <div class="form-group"> 
                                                                                            <input type="text" class="form-control" id="aboutHead<?php echo $i; ?>" name="about_head<?php echo $i; ?>" placeholder="Enter Heading <?php echo $i; ?>" value="<?php echo htmlspecialchars($about_data['about_head' . $i] ?? ''); ?>">
                                                                                        </div>
                                                                                        
                                                                                        <label for="aboutStatement<?php echo $i; ?>">Statement/Content <?php echo $i; ?>:</label>
                                                                                        <div class="form-group"> 
                                                                                            <textarea class="form-control" id="aboutStatement<?php echo $i; ?>" name="about_statement<?php echo $i; ?>" placeholder="Enter Content <?php echo $i; ?>" rows="4"><?php echo htmlspecialchars($about_data['about_statement'. $i] ?? ''); ?></textarea>
                                                                                        </div>
                                                                                    <?php 
                                                                                    endfor; 
                                                                                    ?> 
