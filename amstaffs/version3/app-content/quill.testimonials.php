                        ...
                        <div class="modal-body"> 
                            ...
                            <form action="quill-photos" enctype="multipart/form-data" method="POST">
                               <div class="modal-body">
                                    ...
                                    <div class="form-group"> 
                                        <input type="text" class="form-control" name="testimonial_full_name" required="" value="<?php echo $t_full_name; ?>" placeholder="Enter Full Name">
                                    </div> 

                                    <!-- Profession -->
                                    <label>Profession / Title:</label>
                                    <div class="form-group"> 
                                        <input type="text" class="form-control" name="testimonial_profession" value="<?php echo $t_profession; ?>" placeholder="e.g., CEO, Happy Customer">
                                    </div>
                                    
                                    <!-- Rating -->
                                    <label>Rating (1-5):</label>
                                    <div class="form-group"> 
                                        <input type="number" class="form-control" name="testimonial_rating" value="<?php echo $t_rating; ?>" min="1" max="5" required>
                                    </div>

                                    <!-- Testimonial Content -->
                                    <label>Testimonial Content:</label>
                                    <div class="form-group">
                                        <textarea class="form-control" name="testimonial_content" placeholder="Enter the full testimonial content" rows="5" required><?php echo $t_content; ?></textarea> 
                                    </div> 
                            ...
                            <form action="quill-photos" enctype="multipart/form-data" method="POST">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <input type="text" class="form-control" name="testimonial_full_name" required="" placeholder="Enter Full Name">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <input type="text" class="form-control" name="testimonial_profession" placeholder="e.g., CEO, Happy Customer, Marketing Manager">
                                    </div>
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <input type="number" class="form-control" name="testimonial_rating" value="5" min="1" max="5" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="testimonial_content" placeholder="Enter the full testimonial content" rows="5" required></textarea> 
                                    </div>  
